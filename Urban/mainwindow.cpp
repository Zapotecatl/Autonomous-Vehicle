...
void MainWindow::on_pBInicia_clicked()
{
    ...
    InializedCity(n_h_streets, m_v_streets, d_s_block, dens_h, dens_v, p_t, per_autonomous);
        ...
        if (m_xmlReader.isStartElement()) {
            ...
            if (m_xmlReader.name() == "welcome") {
               ;//Unicamente leyo la etiqueta welcome
                ...
                per_autonomous = m_xmlReader.attributes().value("per_autonomous").toString().toDouble();
                ...
                str_info+= "Densidad H: " + QString::number(dens_h) + "\n" +
                           ...
                           "P. Autonomous: " + QString::number(per_autonomous) + "\n\n";
...
void MainWindow::on_Experiment_clicked()
{
    ...
    //mainFunction(n_h_streets, m_v_streets, d_s_block, p_t, met, _P, maxim_n, maxim_m, min_time, max_time, metodo_s, precision, distance_d, distance_r, distance_e, per_autonomous);
    mainFunctionAutonomous(n_h_streets, m_v_streets, d_s_block, p_t, met, _P, maxim_n, maxim_m, min_time, max_time, metodo_s, precision, distance_d, distance_r, distance_e, per_autonomous);
